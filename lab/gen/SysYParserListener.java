// Generated from C:/Users/ASUS/Desktop/Lab/Lab/src/Antlr.SysYParser.g4 by ANTLR 4.13.2
...
public interface SysYParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code varDefUninit}
	 * labeled alternative in {@link SysYParser#varDef}.
	 * @param ctx the parse tree
	 */
	void enterVarDefUninit(SysYParser.VarDefUninitContext ctx);
	/**
	 * Exit a parse tree produced by the {@code varDefUninit}
	 * labeled alternative in {@link SysYParser#varDef}.
	 * @param ctx the parse tree
	 */
	void exitVarDefUninit(SysYParser.VarDefUninitContext ctx);
	/**
	 * Enter a parse tree produced by the {@code varDefInit}
	 * labeled alternative in {@link SysYParser#varDef}.
	 * @param ctx the parse tree
	 */
	void enterVarDefInit(SysYParser.VarDefInitContext ctx);
	/**
	 * Exit a parse tree produced by the {@code varDefInit}
	 * labeled alternative in {@link SysYParser#varDef}.
	 * @param ctx the parse tree
	 */
	void exitVarDefInit(SysYParser.VarDefInitContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterPrimaryUnary(SysYParser.PrimaryUnaryContext ctx);
	/**
	 * Exit a parse tree produced by the {@code primaryUnary}
	 * labeled alternative in {@link SysYParser#unaryExp}.
	 * @param ctx the parse tree
	 */
	void exitPrimaryUnary(SysYParser.PrimaryUnaryContext ctx);
	/**
